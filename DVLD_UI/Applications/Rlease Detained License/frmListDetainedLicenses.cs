...
namespace DVLD.Applications.Rlease_Detained_License
{
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            _dtDetainedLicenses = DetainedLicense.GetAll();
        ...
        {       
            ...
            int PersonID = License0.Find(LicenseID)?.Driver?.PersonId ?? 0;
        ...
        private void PesonDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int LicenseID = (int)dgvDetainedLicenses.CurrentRow.Cells[1].Value;
            int PersonID = License0.Find(LicenseID)?.Driver?.PersonId ?? 0;
            frmShowPersonInfo frm = new(PersonID);
            frm.ShowDialog();
        }
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int LicenseID = (int)dgvDetainedLicenses.CurrentRow.Cells[1].Value;          
            frmShowLicenseInfo frm = new(LicenseID);
            frm.ShowDialog();
        }
        private void btnDetainLicense_Click(object sender, EventArgs e)
        {
            frmDetainLicenseApplication frm= new(); 
            frm.ShowDialog();
        ...
        {
            int LicenseID = (int)dgvDetainedLicenses.CurrentRow.Cells[1].Value;
            frmReleaseDetainedLicenseApplication frm = new (LicenseID);
            frm.ShowDialog();
            frmListDetainedLicenses_Load(null!, null!);
        }
